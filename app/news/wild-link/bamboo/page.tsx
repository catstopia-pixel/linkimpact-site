...
export default function BambooLinkPage(){
 return <main className="min-h-screen bg-[#f2f6ef] px-4 py-8 text-[#143b24] sm:px-6 sm:py-12">
  <div className="mx-auto max-w-4xl">
   <header className="mb-6 flex items-center justify-between"><Link href="/" className="font-black">◎ LINKIMPACT</Link><Link href="/home" className="text-sm font-bold">HOME →</Link></header>
   <BambooPlantGame />
