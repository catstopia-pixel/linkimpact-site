...
(function () {
  ...
  const dict = {
    en: {
      ...
      "notice.todayClose": "Don’t show again today",
      ...
      "act.eyebrow": "Solidarity, made visible.",
      "act.title": "Activities",
      "act.lead": "We connect world, generation, nation, and community—through culture, education, and action.",
      "act.listTitle": "All posts"
    },
    ...
    ko: {
      ...
      "act.eyebrow": "연대를 눈에 보이게 만듭니다.",
      "act.title": "활동",
      "act.lead": "우리는 문화, 교육, 실천을 통해 세계·세대·국가·공동체를 연결합니다.",
      "act.listTitle": "전체 게시물"
    }
  };
